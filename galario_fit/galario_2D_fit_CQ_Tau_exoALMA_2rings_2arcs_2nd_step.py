...
target = 'CQ_Tau'
filename_lastpkl = 'galario_fullrun_Image2D_2rings_2arcs_40walker_2510steps.pkl'
nsteps = 2
...
# initial guess for the parameters
# read it from the last pkl file (last MCMC run), taking the 50th percentile among the last 'num_steps_oldpkl' steps
uvfitdata_fullrun_lastpkl = pickle.load(open(filename_lastpkl, 'rb'))
samples_lastpkl = uvfitdata_fullrun_lastpkl['emcee_sampler_samples']
p_ranges_lastpkl = uvfitdata_fullrun_lastpkl['model_p_ranges']
p0_lastpkl = uvfitdata_fullrun_lastpkl['model_p0']
nwalkers_lastpkl = uvfitdata_fullrun_lastpkl['model_nwalkers']
nsteps_lastpkl = uvfitdata_fullrun_lastpkl['model_nsteps']
u_lastpkl = uvfitdata_fullrun_lastpkl['uvdata_u']
v_lastpkl = uvfitdata_fullrun_lastpkl['uvdata_v']
Re_lastpkl = uvfitdata_fullrun_lastpkl['uvdata_Re']
Im_lastpkl = uvfitdata_fullrun_lastpkl['uvdata_Im']
w_lastpkl = uvfitdata_fullrun_lastpkl['uvdata_w']
wle_lastpkl = uvfitdata_fullrun_lastpkl['wavelength']

num_steps_lastpkl = 50
ndim = len(p_ranges_lastpkl) 
samples_lastpkl = np.reshape(samples_lastpkl, (nwalkers_lastpkl,1000, ndim))
samples_lastpkl_laststeps = np.reshape(samples_lastpkl[:,(1000-num_steps_lastpkl):,:], (nwalkers_lastpkl*num_steps_lastpkl, ndim))
bestfit_lastpkl = [np.percentile(samples_lastpkl_laststeps[:, i], 50) for i in range(ndim)]
