...
ImportMS_galario('../../data/'+target+'_continuum.ms', 
                 uvtable_galario, make_resid=True)

# Perform the imaging
imagename = f"{folder_path}/{target}_resid_galario_robust{disk.disk[target]['crobust']}"
