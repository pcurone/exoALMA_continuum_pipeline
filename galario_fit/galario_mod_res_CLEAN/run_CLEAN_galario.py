...
#####  Plot settings #####
img_lim = 2.0     # multiple of rout, used to set the limit of the images and the intesity radial profile
...
if im_dat:
    ...
    os.system('casa --nogui --nologger --nologfile -c data_imaging_galario.py')
    print('....')
...
if im_res:
    ...
    print('....')
    os.environ['TARGET'] = target
    os.environ['UVTABLE'] = uvtable_galario
    os.system('casa --nogui --nologger --nologfile -c resid_imaging_galario.py')
    print('....')
...
if im_mdl:
    ...
    os.environ['TARGET'] = target
    os.environ['UVTABLE'] = uvtable_galario
    os.system('casa --nogui --nologerr --nologfile -c model_imaging_galario.py') 
    print('....')
